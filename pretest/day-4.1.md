...
1. What is the difference between `apply()` and `commit()` in Shared Preferences? **False**
2. How would you store a user's login status (true/false) using Shared Preferences in Android? **False**
3. How can you read data from Shared Preferences in Android? **True**
4. What are the advantages of using Shared Preferences over other storage options for small amounts of data? **False**
